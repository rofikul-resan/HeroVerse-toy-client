  ...
  return (
    <section>
      <div className="overflow-hidden h-96 bg-[#9363b5] mb-16 relative">
        ...
        <div className="text-white absolute z-10 inset-0 flex items-center justify-center">
          <div className=" space-y-6 p-6">
            <h3 className="font-bold md:text-center">
              Exclusive Sale On HeroVers
            </h3>
            <h1 className="font-bold md:text-center md:text-5xl">
            ...
            <button className="btn btn-outline btn-success rounded-none   md:ml-60">
              Shop Now
            </button>
          </div>
        </div>
      ...
      <div className="w-10/12 mx-auto grid md:grid-cols-2 gap-9">
        <div className="md:h-[340px] md:w-[560px] overflow-hidden rounded-md relative">
          <img src={img1} alt="" />
          <div className="absolute z-10  right-10 top-6 md:top-1/3 space-y-4">
            <p className="text-white md:text-black font-semibold ">
        ...
        <div className="md:h-[340px] md:w-[560px] overflow-hidden rounded-md relative">
          <img src={img2} alt="" />
          <div className="absolute z-10 left-6 top-6 md:left-10 md:top-1/3 space-y-4">
